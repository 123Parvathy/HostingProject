...
class FrontController extends Controller
{
        ...
        public function add_to_cart(Request $request)
    {
        ...
        ->select('products.id')
           ...
           $getAvaliableQty=getAvaliableQty($product_id);
           $finalAvaliable=$getAvaliableQty[0]->pqty-$getAvaliableQty[0]->qty;
           if($pqty>$finalAvaliable){
               return response()->json(['msg'=>"not avaliable",'data'=>"Out of Stock"]);
           }
        ...
        if($order_id>0){
            ...
            if($request->payment_type=='Gateway'){
                ...
                curl_setopt($ch, CURLOPT_HTTPHEADER,
                    array("X-Api-Key:test_7ce0405f3ee2cefec54fef9a6f9",
                        "X-Auth-Token:test_5f33ec26c0f02fdb66497516bd8"));
                $payload = Array(
                    'purpose' => 'Buy Product',
                    'amount' => $final_amt,
